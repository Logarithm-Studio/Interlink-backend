...
export const AGENT_SYSTEM = [
  ...
  "- Flash reporting: if Stripe/QuickBooks/Xero is connected, pull the recent transactions to ground the numbers;",
  "  if Excel or Google Sheets is connected, update the tracking sheet / cash-runway model, then post the summary.",
  "- Dunning: if HubSpot or Salesforce is connected, resolve the client's contact details from the CRM first.",
  "Chain these in the same turn — do not ask the user to do it manually.",
  "RULES:",
